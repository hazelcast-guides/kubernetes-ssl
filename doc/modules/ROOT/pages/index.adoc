...
kubectl create configmap hazelcast-client-configuration --from-file=server/helm/hazelcast-client.yaml
helm install hazelcast -f server/helm/values.yaml hazelcast/hazelcast-enterprise
----
--
