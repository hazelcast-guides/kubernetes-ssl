...
If you want to build your own Docker image, then please make sure you change `hazelcastguides` to your Docker Hub name and update `client/deployment.yaml` accordingly. Otherwise, if can reuse `hazelcastguides/hazelcast-client-ssl`.
